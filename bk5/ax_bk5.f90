module ax_bk5
  ...
  interface
     subroutine ax_bk5_kernel(w, u, dx, dy, dz, dxt, dyt, dzt, &
          g1, g2, g3, g4, g5, g6, nelv, lx) &
          bind(c, name='hip_ax_bk5')
       use, intrinsic :: iso_c_binding
       implicit none
       type(c_ptr), value :: w, u, dx, dy, dz, dxt, dyt, dzt
       type(c_ptr), value :: g1, g2, g3, g4, g5, g6
